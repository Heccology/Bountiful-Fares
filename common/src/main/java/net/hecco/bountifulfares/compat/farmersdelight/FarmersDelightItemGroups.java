...
//            ResourceKey.create(Registries.CREATIVE_MODE_TAB, ResourceLocation.fromNamespaceAndPath(BountifulFares.MOD_ID, "bountiful_fares")
//            );
//    public static final ResourceKey<CreativeModeTab> FARMERS_DELIGHT_TAB =
//            ResourceKey.create(Registries.CREATIVE_MODE_TAB, ResourceLocation.fromNamespaceAndPath(BountifulFares.FARMERS_DELIGHT_MOD_ID, "farmersdelight")
//            );
//
//    public static void tabFarmersDelight(FabricItemGroupEntries tab)
//    {
//        Block warped_cabinet = BuiltInRegistries.BLOCK.get(ResourceLocation.fromNamespaceAndPath(BountifulFares.FARMERS_DELIGHT_MOD_ID, "warped_cabinet"));
//
