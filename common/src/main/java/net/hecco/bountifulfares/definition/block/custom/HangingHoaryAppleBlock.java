...
public class HangingHoaryAppleBlock extends HangingFruitBlock {
    ...
    public boolean canSurvive(BlockState state, LevelReader world, BlockPos pos) {
        return (Block.canSupportCenter(world, pos.above(), Direction.DOWN) || world.getBlockState(pos.above()).is(BFBlocks.HOARY_LEAVES.get())) && !world.isWaterAt(pos);
    }
    ...
    public InteractionResult useWithoutItem(BlockState state, Level world, BlockPos pos, Player player, BlockHitResult hit) {
        ...
        if (i == 4) {
            ...
            world.playSound(null, pos, BFSounds.HANGING_FRUIT_PICK.get(), SoundSource.BLOCKS, 1.0f, 0.7f + world.random.nextFloat() * 0.4f);
