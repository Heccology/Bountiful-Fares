...
public class PieBlock extends QuarterPastryBlock {
    ...
    public static final VoxelShape[] NORTH_SHAPES = new VoxelShape[] {
            ...
            Shapes.join(Block.box(1, 0, 8, 15, 6, 15), Block.box(8, 0, 1, 15, 6, 8), BooleanOp.OR),
            Block.box(1, 0, 8, 15, 6, 15),
            Block.box(1, 0, 8, 8, 6, 15)
    };
    public static final VoxelShape[] EAST_SHAPES = new VoxelShape[] {
            Block.box(1, 0, 1, 15, 6, 15),
            Shapes.join(Block.box(8, 0, 8, 15, 6, 15), Block.box(1, 0, 1, 8, 6, 15), BooleanOp.OR),
            Block.box(1, 0, 1, 8, 6, 15),
            Block.box(1, 0, 1, 8, 6, 8)
    };
    public static final VoxelShape[] SOUTH_SHAPES = new VoxelShape[] {
            Block.box(1, 0, 1, 15, 6, 15),
            Shapes.join(Block.box(1, 0, 8, 8, 6, 15), Block.box(1, 0, 1, 15, 6, 8), BooleanOp.OR),
            Block.box(1, 0, 1, 15, 6, 8),
            Block.box(8, 0, 1, 15, 6, 8)
    };
    public static final VoxelShape[] WEST_SHAPES = new VoxelShape[] {
            Block.box(1, 0, 1, 15, 6, 15),
            Shapes.join(Block.box(1, 0, 1, 8, 6, 8), Block.box(8, 0, 1, 15, 6, 15), BooleanOp.OR),
            Block.box(8, 0, 1, 15, 6, 15),
            Block.box(8, 0, 8, 15, 6, 15)
    };
