...
public class BFItems {
    ...
    public static final Supplier<Item> FOUL_FLESH = registerItem("foul_flesh", () -> new FoulFleshItem(new Item.Properties().food(new FoodProperties.Builder().nutrition(0).saturationModifier(0f).effect(new MobEffectInstance(MobEffects.HUNGER, 300, 0), 1).alwaysEdible().build())));
    ...
    public static final Supplier<Item> CUP = registerItem("jar", () -> new CupItem(new Item.Properties()));
    public static final Supplier<Item> APPLE_COMPOTE_JAR = registerItem("apple_compote_jar", () -> new EdibleJarItem(List.of(new MobEffectInstance(BFEffects.ENRICHMENT, 1200, 0)), SoundEvents.HONEY_DRINK, new Item.Properties().stacksTo(16).craftRemainder(CUP.get()).food(new FoodProperties.Builder().nutrition(6).saturationModifier(0.4f).effect(new MobEffectInstance(BFEffects.ENRICHMENT, 1200, 0), 1f).build()).craftRemainder(BFItems.CUP.get())));
    public static final Supplier<Item> ORANGE_COMPOTE_JAR = registerItem("orange_compote_jar", () -> new EdibleJarItem(List.of(new MobEffectInstance(BFEffects.ENRICHMENT, 1200, 0)), SoundEvents.HONEY_DRINK, new Item.Properties().stacksTo(16).craftRemainder(CUP.get()).food(new FoodProperties.Builder().nutrition(6).saturationModifier(0.4f).effect(new MobEffectInstance(BFEffects.ENRICHMENT, 1200, 0), 1f).build()).craftRemainder(BFItems.CUP.get())));
    public static final Supplier<Item> LEMON_COMPOTE_JAR = registerItem("lemon_compote_jar", () -> new EdibleJarItem(List.of(new MobEffectInstance(BFEffects.ENRICHMENT, 1200, 0)), SoundEvents.HONEY_DRINK, new Item.Properties().stacksTo(16).craftRemainder(CUP.get()).food(new FoodProperties.Builder().nutrition(6).saturationModifier(0.4f).effect(new MobEffectInstance(BFEffects.ENRICHMENT, 1200, 0), 1f).build()).craftRemainder(BFItems.CUP.get())));
    ...
    public static final Supplier<Item> APPLE_CIDER_JAR = registerItem("apple_cider_jar", () -> new LiquidJarItem(new Item.Properties().stacksTo(16).craftRemainder(CUP.get()).food(new FoodProperties.Builder().nutrition(6).saturationModifier(0.6f).build())));
    public static final Supplier<Item> PLUM_CIDER_JAR = registerItem("plum_cider_jar", () -> new LiquidJarItem(new Item.Properties().stacksTo(16).craftRemainder(CUP.get()).food(new FoodProperties.Builder().nutrition(6).saturationModifier(0.6f).build())));
    public static final Supplier<Item> HOARY_CIDER_JAR = registerItem("hoary_cider_jar", () -> new LiquidJarItem(new Item.Properties().stacksTo(16).craftRemainder(CUP.get()).food(new FoodProperties.Builder().nutrition(6).saturationModifier(0.6f).build())));
    ...
    public static final Supplier<Item> WATER_CUP = registerItem("water_cup", () -> new WaterCupItem(new Item.Properties().stacksTo(16)));
    public static final Supplier<Item> GREEN_TEA_CUP = registerItem("green_tea_bottle", () -> new GreenTeaBottleItem(new Item.Properties().stacksTo(16).craftRemainder(BFItems.CUP.get()).food(new FoodProperties.Builder().nutrition(4).saturationModifier(1f).effect(new MobEffectInstance(BFEffects.EBULLIENCE, 6000, 0, true, true), 1f).alwaysEdible().build())));
    public static final Supplier<Item> BLACK_TEA_CUP = registerItem("black_tea_bottle", () -> new BlackTeaBottleItem(new Item.Properties().stacksTo(16).craftRemainder(BFItems.CUP.get()).food(new FoodProperties.Builder().nutrition(4).saturationModifier(1f).effect(new MobEffectInstance(BFEffects.EBULLIENCE, 6000, 0, true, true), 1f).alwaysEdible().build())));
    public static final Supplier<Item> CHAMOMILE_TEA_CUP = registerItem("chamomile_tea_bottle", () -> new ChamomileTeaBottleItem(new Item.Properties().stacksTo(16).craftRemainder(BFItems.CUP.get()).food(new FoodProperties.Builder().nutrition(4).saturationModifier(1f).effect(new MobEffectInstance(BFEffects.EBULLIENCE, 6000, 0, true, true), 1f).alwaysEdible().build())));
    public static final Supplier<Item> HONEYSUCKLE_TEA_CUP = registerItem("honeysuckle_tea_bottle", () -> new HoneysuckleTeaBottleItem(new Item.Properties().stacksTo(16).craftRemainder(BFItems.CUP.get()).food(new FoodProperties.Builder().nutrition(4).saturationModifier(1f).effect(new MobEffectInstance(BFEffects.EBULLIENCE, 6000, 0, true, true), 1f).alwaysEdible().build())));
    public static final Supplier<Item> BELLFLOWER_TEA_CUP = registerItem("bellflower_tea_bottle", () -> new BellflowerTeaBottleItem(new Item.Properties().stacksTo(16).craftRemainder(BFItems.CUP.get()).food(new FoodProperties.Builder().nutrition(4).saturationModifier(1f).effect(new MobEffectInstance(BFEffects.EBULLIENCE, 6000, 0, true, true), 1f).alwaysEdible().build())));
    public static final Supplier<Item> TORCHFLOWER_TEA_CUP = registerItem("torchflower_tea_bottle", () -> new TorchflowerTeaBottleItem(new Item.Properties().stacksTo(16).craftRemainder(BFItems.CUP.get()).food(new FoodProperties.Builder().nutrition(4).saturationModifier(1f).effect(new MobEffectInstance(BFEffects.EBULLIENCE, 6000, 0, true, true), 1f).alwaysEdible().build())));
    ...
    public static final Supplier<Item> PASSION_GLAZED_SALMON = registerItem("passion_glazed_salmon", () -> new StackableBowlFoodItem(List.of(new MobEffectInstance(BFEffects.ENRICHMENT, 2400, 0, true, true)), new Item.Properties().stacksTo(16).food(new FoodProperties.Builder().usingConvertsTo(Items.BOWL).nutrition(8).saturationModifier(0.7F).effect(new MobEffectInstance(BFEffects.ENRICHMENT, 2400, 0, true, true), 1).build()).craftRemainder(Items.BOWL)));
    public static final Supplier<Item> COCONUT_CRUSTED_COD = registerItem("coconut_crusted_cod", () -> new StackableBowlFoodItem(List.of(new MobEffectInstance(BFEffects.ENRICHMENT, 2400, 0, true, true)), new Item.Properties().stacksTo(16).food(new FoodProperties.Builder().usingConvertsTo(Items.BOWL).usingConvertsTo(Items.BOWL).nutrition(8).saturationModifier(0.7F).effect(new MobEffectInstance(BFEffects.ENRICHMENT, 2400, 0, true, true), 1).build()).craftRemainder(Items.BOWL)));
    public static final Supplier<Item> BOUNTIFUL_STEW = registerItem("bountiful_stew", () -> new StackableBowlFoodItem(List.of(new MobEffectInstance(BFEffects.ENRICHMENT, 2400, 0, true, true)), new Item.Properties().stacksTo(16).food((new FoodProperties.Builder().usingConvertsTo(Items.BOWL).usingConvertsTo(Items.BOWL)).nutrition(10).saturationModifier(0.6F).effect(new MobEffectInstance(BFEffects.RESTORATION, 2400, 0, true, true), 1).build()).craftRemainder(Items.BOWL)));
    public static final Supplier<Item> CRUSTED_BEEF = registerItem("crusted_beef", () -> new StackableBowlFoodItem(List.of(new MobEffectInstance(BFEffects.ENRICHMENT, 2400, 0, true, true)), new Item.Properties().stacksTo(16).food(new FoodProperties.Builder().usingConvertsTo(Items.BOWL).nutrition(10).saturationModifier(0.7F).effect(new MobEffectInstance(BFEffects.ENRICHMENT, 2400, 0, true, true), 1).build()).craftRemainder(Items.BOWL)));
    public static final Supplier<Item> LEEK_STEW = registerItem("leek_stew", () -> new StackableBowlFoodItem(List.of(new MobEffectInstance(BFEffects.ENRICHMENT, 1800, 0, true, true)), new Item.Properties().stacksTo(16).food(new FoodProperties.Builder().usingConvertsTo(Items.BOWL).nutrition(6).saturationModifier(0.6F).effect(new MobEffectInstance(BFEffects.ENRICHMENT, 1800, 0, true, true), 1).build()).craftRemainder(Items.BOWL)));
    public static final Supplier<Item> FISH_STEW = registerItem("fish_stew", () -> new StackableBowlFoodItem(List.of(new MobEffectInstance(BFEffects.RESTORATION, 1800, 0, true, true)), new Item.Properties().stacksTo(16).food(new FoodProperties.Builder().usingConvertsTo(Items.BOWL).nutrition(10).saturationModifier(0.6F).effect(new MobEffectInstance(BFEffects.RESTORATION, 1800, 0, true, true), 1).build()).craftRemainder(Items.BOWL)));
    public static final Supplier<Item> STONE_STEW = registerItem("stone_stew", () -> new StackableBowlFoodItem(new Item.Properties().stacksTo(16).food(new FoodProperties.Builder().usingConvertsTo(Items.BOWL).nutrition(5).saturationModifier(0.4F).build()).craftRemainder(Items.BOWL)));
    public static final Supplier<Item> APPLE_STEW = registerItem("apple_stew", () -> new StackableBowlFoodItem(List.of(new MobEffectInstance(BFEffects.RESTORATION, 1800, 0, true, true)), new Item.Properties().stacksTo(16).food(new FoodProperties.Builder().usingConvertsTo(Items.BOWL).nutrition(10).saturationModifier(0.5F).effect(new MobEffectInstance(BFEffects.RESTORATION, 1800, 0, true, true), 1).build()).craftRemainder(Items.BOWL)));
    public static final Supplier<Item> COCONUT_STEW = registerItem("coconut_stew", () -> new StackableBowlFoodItem(List.of(new MobEffectInstance(BFEffects.RESTORATION, 1800, 0, true, true)), new Item.Properties().stacksTo(16).food(new FoodProperties.Builder().usingConvertsTo(Items.BOWL).nutrition(10).saturationModifier(0.6F).effect(new MobEffectInstance(BFEffects.RESTORATION, 1800, 0, true, true), 1).build()).craftRemainder(Items.BOWL)));
    public static final Supplier<Item> SEA_SALAD = registerItem("sea_salad", () -> new StackableBowlFoodItem(new Item.Properties().stacksTo(16).food(new FoodProperties.Builder().usingConvertsTo(Items.BOWL).nutrition(6).saturationModifier(0.5F).build()).craftRemainder(Items.BOWL)));
    ...
    public static final Supplier<Item> CRIMSON_CHOW = registerItem("crimson_chow", () -> new StackableBowlFoodItem(new Item.Properties().stacksTo(16).food(new FoodProperties.Builder().usingConvertsTo(Items.BOWL).nutrition(10).saturationModifier(0.8F).build()).craftRemainder(Items.BOWL)));
    public static final Supplier<Item> WARPED_CHOW = registerItem("warped_chow", () -> new StackableBowlFoodItem(new Item.Properties().stacksTo(16).food(new FoodProperties.Builder().usingConvertsTo(Items.BOWL).nutrition(8).saturationModifier(0.7F).build()).craftRemainder(Items.BOWL)));
