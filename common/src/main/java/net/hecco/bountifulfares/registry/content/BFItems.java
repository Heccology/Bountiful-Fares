...
public class BFItems {
    ...
    public static final Supplier<Item> GREEN_TEA_CUP = registerItem("green_tea_bottle", () -> new GreenTeaBottleItem(new Item.Properties().stacksTo(16).craftRemainder(Items.GLASS_BOTTLE).food(new FoodProperties.Builder().nutrition(4).saturationModifier(1f).effect(new MobEffectInstance(BFEffects.EBULLIENCE, 6000, 0, true, true), 1f).alwaysEdible().build())));
    ...
    public static final Supplier<Item> CHAMOMILE_TEA_CUP = registerItem("chamomile_tea_bottle", () -> new ChamomileTeaBottleItem(new Item.Properties().stacksTo(16).craftRemainder(Items.GLASS_BOTTLE).food(new FoodProperties.Builder().nutrition(4).saturationModifier(1f).effect(new MobEffectInstance(BFEffects.EBULLIENCE, 6000, 0, true, true), 1f).alwaysEdible().build())));
    ...
    public static final Supplier<Item> TORCHFLOWER_TEA_CUP = registerItem("torchflower_tea_bottle", () -> new TorchflowerTeaBottleItem(new Item.Properties().stacksTo(16).craftRemainder(Items.GLASS_BOTTLE).food(new FoodProperties.Builder().nutrition(4).saturationModifier(1f).effect(new MobEffectInstance(BFEffects.EBULLIENCE, 6000, 0, true, true), 1f).alwaysEdible().build())));
