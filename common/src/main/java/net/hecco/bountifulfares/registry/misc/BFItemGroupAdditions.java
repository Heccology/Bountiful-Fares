...
public class BFItemGroupAdditions {
    ...
    public static void registerItemGroupAdditions() {
        ...
        FOOD_AND_DRINKS.add(ItemGroupAddition.create(Items.APPLE, BFItems.APPLE_CIDER_JAR.get().asItem().getDefaultInstance()));
        FOOD_AND_DRINKS.add(ItemGroupAddition.create(Items.APPLE, BFBlocks.APPLE_BLOCK.get().asItem().getDefaultInstance()));
        FOOD_AND_DRINKS.add(ItemGroupAddition.create(Items.APPLE, BFItems.ORANGE.get().asItem().getDefaultInstance()));
        FOOD_AND_DRINKS.add(ItemGroupAddition.create(Items.APPLE, BFItems.ORANGE_COMPOTE_JAR.get().asItem().getDefaultInstance()));
        FOOD_AND_DRINKS.add(ItemGroupAddition.create(Items.APPLE, BFBlocks.ORANGE_BLOCK.get().asItem().getDefaultInstance()));
        FOOD_AND_DRINKS.add(ItemGroupAddition.create(Items.APPLE, BFItems.LEMON.get().asItem().getDefaultInstance()));
        FOOD_AND_DRINKS.add(ItemGroupAddition.create(Items.APPLE, BFItems.LEMON_COMPOTE_JAR.get().asItem().getDefaultInstance()));
        FOOD_AND_DRINKS.add(ItemGroupAddition.create(Items.APPLE, BFBlocks.LEMON_BLOCK.get().asItem().getDefaultInstance()));
        FOOD_AND_DRINKS.add(ItemGroupAddition.create(Items.APPLE, BFItems.PLUM.get().asItem().getDefaultInstance()));
        FOOD_AND_DRINKS.add(ItemGroupAddition.create(Items.APPLE, BFItems.PLUM_COMPOTE_JAR.get().asItem().getDefaultInstance()));
        FOOD_AND_DRINKS.add(ItemGroupAddition.create(Items.APPLE, BFItems.PLUM_CIDER_JAR.get().asItem().getDefaultInstance()));
        FOOD_AND_DRINKS.add(ItemGroupAddition.create(Items.APPLE, BFBlocks.PLUM_BLOCK.get().asItem().getDefaultInstance()));
        FOOD_AND_DRINKS.add(ItemGroupAddition.create(Items.APPLE, BFItems.HOARY_APPLE.get().asItem().getDefaultInstance()));
        FOOD_AND_DRINKS.add(ItemGroupAddition.create(Items.APPLE, BFItems.STUFFED_HOARY_APPLE.get().asItem().getDefaultInstance()));
        FOOD_AND_DRINKS.add(ItemGroupAddition.create(Items.APPLE, BFItems.HOARY_COMPOTE_JAR.get().asItem().getDefaultInstance()));
        FOOD_AND_DRINKS.add(ItemGroupAddition.create(Items.APPLE, BFItems.HOARY_CIDER_JAR.get().asItem().getDefaultInstance()));
        FOOD_AND_DRINKS.add(ItemGroupAddition.create(Items.APPLE, BFBlocks.HOARY_APPLE_BLOCK.get().asItem().getDefaultInstance()));
        FOOD_AND_DRINKS.add(ItemGroupAddition.create(Items.APPLE, BFItems.COCONUT_HALF.get().asItem().getDefaultInstance()));
        ...
        FOOD_AND_DRINKS.add(ItemGroupAddition.create(Items.MELON_SLICE, BFItems.PICKLED_SPONGEKIN.get().asItem().getDefaultInstance()));
        FOOD_AND_DRINKS.add(ItemGroupAddition.create(Items.SWEET_BERRIES, BFItems.PASSION_FRUIT.get().asItem().getDefaultInstance()));
        FOOD_AND_DRINKS.add(ItemGroupAddition.create(Items.SWEET_BERRIES, BFItems.ELDERBERRIES.get().asItem().getDefaultInstance()));
        FOOD_AND_DRINKS.add(ItemGroupAddition.create(Items.SWEET_BERRIES, BFItems.ELDERBERRY_WINE_BOTTLE.get().asItem().getDefaultInstance()));
        FOOD_AND_DRINKS.add(ItemGroupAddition.create(Items.GLOW_BERRIES, BFItems.LAPISBERRIES.get().asItem().getDefaultInstance()));
        FOOD_AND_DRINKS.add(ItemGroupAddition.create(Items.GLOW_BERRIES, BFItems.LAPISBERRY_WINE_BOTTLE.get().asItem().getDefaultInstance()));
        FOOD_AND_DRINKS.add(ItemGroupAddition.create(Items.MILK_BUCKET, BFItems.COCONUT_MILK_BOTTLE.get().asItem().getDefaultInstance()));
        FOOD_AND_DRINKS.add(ItemGroupAddition.create(Items.MILK_BUCKET, BFItems.WATER_CUP.get().asItem().getDefaultInstance()));
        FOOD_AND_DRINKS.add(ItemGroupAddition.create(Items.MILK_BUCKET, BFItems.GREEN_TEA_CUP.get().asItem().getDefaultInstance()));
        FOOD_AND_DRINKS.add(ItemGroupAddition.create(Items.MILK_BUCKET, BFItems.BLACK_TEA_CUP.get().asItem().getDefaultInstance()));
        FOOD_AND_DRINKS.add(ItemGroupAddition.create(Items.MILK_BUCKET, BFItems.CHAMOMILE_TEA_CUP.get().asItem().getDefaultInstance()));
        FOOD_AND_DRINKS.add(ItemGroupAddition.create(Items.MILK_BUCKET, BFItems.HONEYSUCKLE_TEA_CUP.get().asItem().getDefaultInstance()));
        FOOD_AND_DRINKS.add(ItemGroupAddition.create(Items.MILK_BUCKET, BFItems.BELLFLOWER_TEA_CUP.get().asItem().getDefaultInstance()));
        FOOD_AND_DRINKS.add(ItemGroupAddition.create(Items.MILK_BUCKET, BFItems.TORCHFLOWER_TEA_CUP.get().asItem().getDefaultInstance()));
        ...
        FOOD_AND_DRINKS.add(ItemGroupAddition.create(Items.BAKED_POTATO, BFItems.BERRY_STUFFED_POTATO.get().asItem().getDefaultInstance()));
        FOOD_AND_DRINKS.add(ItemGroupAddition.create(Items.BAKED_POTATO, BFItems.MAIZE_STUFFED_POTATO.get().asItem().getDefaultInstance()));
        FOOD_AND_DRINKS.add(ItemGroupAddition.create(Items.BEETROOT, BFItems.PICKLED_BEETROOT.get().asItem().getDefaultInstance()));
        FOOD_AND_DRINKS.add(ItemGroupAddition.create(Items.BEETROOT, BFItems.MAIZE.get().asItem().getDefaultInstance()));
        FOOD_AND_DRINKS.add(ItemGroupAddition.create(Items.BEETROOT, BFItems.LEEK.get().asItem().getDefaultInstance()));
        FOOD_AND_DRINKS.add(ItemGroupAddition.create(Items.BEETROOT, BFItems.WALNUT.get().asItem().getDefaultInstance()));
        FOOD_AND_DRINKS.add(ItemGroupAddition.create(Items.BEETROOT, BFItems.POPPED_MAIZE.get().asItem().getDefaultInstance()));
        ...
        FOOD_AND_DRINKS.add(ItemGroupAddition.create(Items.BREAD, BFBlocks.ARTISAN_BREAD.get().asItem().getDefaultInstance()));
        FOOD_AND_DRINKS.add(ItemGroupAddition.create(Items.COOKIE, BFItems.WALNUT_COOKIE.get().asItem().getDefaultInstance()));
        FOOD_AND_DRINKS.add(ItemGroupAddition.create(Items.COOKIE, BFItems.ARTISAN_COOKIE.get().asItem().getDefaultInstance()));
        FOOD_AND_DRINKS.add(ItemGroupAddition.create(Items.COOKIE, BFBlocks.PASSION_FRUIT_TART.get().asItem().getDefaultInstance()));
        FOOD_AND_DRINKS.add(ItemGroupAddition.create(Items.COOKIE, BFBlocks.ELDERBERRY_TART.get().asItem().getDefaultInstance()));
        FOOD_AND_DRINKS.add(ItemGroupAddition.create(Items.COOKIE, BFBlocks.GLOW_BERRY_TART.get().asItem().getDefaultInstance()));
        FOOD_AND_DRINKS.add(ItemGroupAddition.create(Items.COOKIE, BFBlocks.SWEET_BERRY_TART.get().asItem().getDefaultInstance()));
        FOOD_AND_DRINKS.add(ItemGroupAddition.create(Items.COOKIE, BFBlocks.LAPISBERRY_TART.get().asItem().getDefaultInstance()));
        FOOD_AND_DRINKS.add(ItemGroupAddition.create(Items.CAKE, BFBlocks.COCOA_CAKE.get().asItem().getDefaultInstance()));
        FOOD_AND_DRINKS.add(ItemGroupAddition.create(Items.CAKE, BFBlocks.COCONUT_CAKE.get().asItem().getDefaultInstance()));
        FOOD_AND_DRINKS.add(ItemGroupAddition.create(Items.CAKE, BFBlocks.SPONGE_CAKE.get().asItem().getDefaultInstance()));
        FOOD_AND_DRINKS.add(ItemGroupAddition.create(Items.PUMPKIN_PIE, BFBlocks.MELON_PIE.get().asItem().getDefaultInstance()));
        FOOD_AND_DRINKS.add(ItemGroupAddition.create(Items.PUMPKIN_PIE, BFBlocks.APPLE_PIE.get().asItem().getDefaultInstance()));
        FOOD_AND_DRINKS.add(ItemGroupAddition.create(Items.PUMPKIN_PIE, BFBlocks.ORANGE_PIE.get().asItem().getDefaultInstance()));
        FOOD_AND_DRINKS.add(ItemGroupAddition.create(Items.PUMPKIN_PIE, BFBlocks.LEMON_PIE.get().asItem().getDefaultInstance()));
        FOOD_AND_DRINKS.add(ItemGroupAddition.create(Items.PUMPKIN_PIE, BFBlocks.PLUM_PIE.get().asItem().getDefaultInstance()));
        FOOD_AND_DRINKS.add(ItemGroupAddition.create(Items.PUMPKIN_PIE, BFBlocks.HOARY_PIE.get().asItem().getDefaultInstance()));
        ...
        FOOD_AND_DRINKS.add(ItemGroupAddition.create(Items.SPIDER_EYE, BFItems.CANDY.get().asItem().getDefaultInstance()));
        FOOD_AND_DRINKS.add(ItemGroupAddition.create(Items.SPIDER_EYE, BFItems.PIQUANT_CANDY.get().asItem().getDefaultInstance()));
        FOOD_AND_DRINKS.add(ItemGroupAddition.create(Items.SPIDER_EYE, BFItems.SOUR_CANDY.get().asItem().getDefaultInstance()));
        FOOD_AND_DRINKS.add(ItemGroupAddition.create(Items.SPIDER_EYE, BFItems.BITTER_CANDY.get().asItem().getDefaultInstance()));
        FOOD_AND_DRINKS.add(ItemGroupAddition.create(Items.SPIDER_EYE, BFItems.STRANGE_CANDY.get().asItem().getDefaultInstance()));
        FOOD_AND_DRINKS.add(ItemGroupAddition.create(Items.SPIDER_EYE, BFItems.CANDIED_APPLE.get().asItem().getDefaultInstance()));
        FOOD_AND_DRINKS.add(ItemGroupAddition.create(Items.SPIDER_EYE, BFItems.CANDIED_PLUM.get().asItem().getDefaultInstance()));
        FOOD_AND_DRINKS.add(ItemGroupAddition.create(Items.SPIDER_EYE, BFItems.CANDIED_ORANGE.get().asItem().getDefaultInstance()));
        FOOD_AND_DRINKS.add(ItemGroupAddition.create(Items.SPIDER_EYE, BFItems.CANDIED_LEMON.get().asItem().getDefaultInstance()));
        FOOD_AND_DRINKS.add(ItemGroupAddition.create(Items.SPIDER_EYE, BFItems.FOREST_MEDLEY.get().asItem().getDefaultInstance()));
        FOOD_AND_DRINKS.add(ItemGroupAddition.create(Items.SPIDER_EYE, BFItems.ARID_MEDLEY.get().asItem().getDefaultInstance()));
        FOOD_AND_DRINKS.add(ItemGroupAddition.create(Items.SPIDER_EYE, BFItems.MEADOW_MEDLEY.get().asItem().getDefaultInstance()));
        FOOD_AND_DRINKS.add(ItemGroupAddition.create(Items.SPIDER_EYE, BFItems.MIRE_MEDLEY.get().asItem().getDefaultInstance()));
        FOOD_AND_DRINKS.add(ItemGroupAddition.create(Items.SPIDER_EYE, BFItems.COASTAL_MEDLEY.get().asItem().getDefaultInstance()));
        FOOD_AND_DRINKS.add(ItemGroupAddition.create(Items.SPIDER_EYE, BFItems.TROPICAL_MEDLEY.get().asItem().getDefaultInstance()));
        FOOD_AND_DRINKS.add(ItemGroupAddition.create(Items.SPIDER_EYE, BFItems.SEA_SALAD.get().asItem().getDefaultInstance()));
        FOOD_AND_DRINKS.add(ItemGroupAddition.create(Items.RABBIT_STEW, BFItems.LEEK_STEW.get().asItem().getDefaultInstance()));
        FOOD_AND_DRINKS.add(ItemGroupAddition.create(Items.RABBIT_STEW, BFItems.FISH_STEW.get().asItem().getDefaultInstance()));
        FOOD_AND_DRINKS.add(ItemGroupAddition.create(Items.RABBIT_STEW, BFItems.APPLE_STEW.get().asItem().getDefaultInstance()));
        FOOD_AND_DRINKS.add(ItemGroupAddition.create(Items.RABBIT_STEW, BFItems.COCONUT_STEW.get().asItem().getDefaultInstance()));
        FOOD_AND_DRINKS.add(ItemGroupAddition.create(Items.RABBIT_STEW, BFItems.STONE_STEW.get().asItem().getDefaultInstance()));
        FOOD_AND_DRINKS.add(ItemGroupAddition.create(Items.RABBIT_STEW, BFItems.BOUNTIFUL_STEW.get().asItem().getDefaultInstance()));
        FOOD_AND_DRINKS.add(ItemGroupAddition.create(Items.RABBIT_STEW, BFItems.COCONUT_CRUSTED_COD.get().asItem().getDefaultInstance()));
        FOOD_AND_DRINKS.add(ItemGroupAddition.create(Items.RABBIT_STEW, BFItems.PASSION_GLAZED_SALMON.get().asItem().getDefaultInstance()));
        FOOD_AND_DRINKS.add(ItemGroupAddition.create(Items.RABBIT_STEW, BFItems.CRUSTED_BEEF.get().asItem().getDefaultInstance()));
        FOOD_AND_DRINKS.add(ItemGroupAddition.create(Items.RABBIT_STEW, BFItems.CRIMSON_CHOW.get().asItem().getDefaultInstance()));
        FOOD_AND_DRINKS.add(ItemGroupAddition.create(Items.RABBIT_STEW, BFItems.WARPED_CHOW.get().asItem().getDefaultInstance()));
        ...
        Collections.reverse(FOOD_AND_DRINKS);
