...
public class BFItemGroupAdditions {
    ...
    public static void registerItemGroupAdditions() {
        ...
        BUILDING_BLOCKS.add(new Pair<>(Items.OAK_FENCE_GATE, BFBlocks.OAK_PICKETS.get().asItem().getDefaultInstance()));
        BUILDING_BLOCKS.add(new Pair<>(Items.SPRUCE_FENCE_GATE, BFBlocks.SPRUCE_PICKETS.get().asItem().getDefaultInstance()));
        BUILDING_BLOCKS.add(new Pair<>(Items.BIRCH_FENCE_GATE, BFBlocks.BIRCH_PICKETS.get().asItem().getDefaultInstance()));
        BUILDING_BLOCKS.add(new Pair<>(Items.JUNGLE_FENCE_GATE, BFBlocks.JUNGLE_PICKETS.get().asItem().getDefaultInstance()));
        BUILDING_BLOCKS.add(new Pair<>(Items.ACACIA_FENCE_GATE, BFBlocks.ACACIA_PICKETS.get().asItem().getDefaultInstance()));
        BUILDING_BLOCKS.add(new Pair<>(Items.DARK_OAK_FENCE_GATE, BFBlocks.DARK_OAK_PICKETS.get().asItem().getDefaultInstance()));
        BUILDING_BLOCKS.add(new Pair<>(Items.MANGROVE_FENCE_GATE, BFBlocks.MANGROVE_PICKETS.get().asItem().getDefaultInstance()));
        BUILDING_BLOCKS.add(new Pair<>(Items.CHERRY_FENCE_GATE, BFBlocks.CHERRY_PICKETS.get().asItem().getDefaultInstance()));
        BUILDING_BLOCKS.add(new Pair<>(Items.BAMBOO_FENCE_GATE, BFBlocks.BAMBOO_PICKETS.get().asItem().getDefaultInstance()));
        ...
        BUILDING_BLOCKS.add(new Pair<>(BFBlocks.WALNUT_FENCE_GATE.get(), BFBlocks.WALNUT_PICKETS.get().asItem().getDefaultInstance()));
        BUILDING_BLOCKS.add(new Pair<>(BFBlocks.WALNUT_PICKETS.get(), BFBlocks.WALNUT_DOOR.get().asItem().getDefaultInstance()));
        ...
        BUILDING_BLOCKS.add(new Pair<>(BFBlocks.HOARY_FENCE_GATE.get(), BFBlocks.HOARY_PICKETS.get().asItem().getDefaultInstance()));
        BUILDING_BLOCKS.add(new Pair<>(BFBlocks.HOARY_PICKETS.get(), BFBlocks.HOARY_DOOR.get().asItem().getDefaultInstance()));
        ...
        BUILDING_BLOCKS.add(new Pair<>(Items.CRIMSON_FENCE_GATE, BFBlocks.CRIMSON_PICKETS.get().asItem().getDefaultInstance()));
        BUILDING_BLOCKS.add(new Pair<>(Items.WARPED_FENCE_GATE, BFBlocks.WARPED_PICKETS.get().asItem().getDefaultInstance()));
