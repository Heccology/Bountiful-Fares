...
public class BFTrellises {
    ...
    public static final TrellisVariant WALNUT = new TrellisVariant(BountifulFares.MOD_ID, "walnut", BFBlocks.WALNUT_PLANKS.asItem(), TRELLIS_RENDER_CUTOUT);
    public static final TrellisVariant HOARY = new TrellisVariant(BountifulFares.MOD_ID, "hoary", BFBlocks.HOARY_PLANKS.asItem(), TRELLIS_RENDER_CUTOUT);
