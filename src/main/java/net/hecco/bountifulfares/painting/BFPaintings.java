...
//        return Registry.register(Registries.PAINTING_VARIANT, Identifier.of(BountifulFares.MOD_ID, name), paintingVariant);
//    }
...
//            HAZEL_FLORET = register("hazel_floret", new PaintingVariant(16, 16));
//        }
