...
public class ModItemTags {
    public static final TagKey<Item> APPLE_LOGS = TagKey.of(RegistryKeys.ITEM, new Identifier(BountifulFares.MOD_ID, "apple_logs"));
    public static final TagKey<Item> ORANGE_LOGS = TagKey.of(RegistryKeys.ITEM, new Identifier(BountifulFares.MOD_ID, "orange_logs"));
    public static final TagKey<Item> LEMON_LOGS = TagKey.of(RegistryKeys.ITEM, new Identifier(BountifulFares.MOD_ID, "lemon_logs"));
    ...
    public static final TagKey<Item> VINE_CROP_SEEDS = TagKey.of(RegistryKeys.ITEM, new Identifier(BountifulFares.MOD_ID, "vine_crop_seeds"));
