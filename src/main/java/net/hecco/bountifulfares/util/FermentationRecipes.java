...
//    If the player is not using the correct collector, a message will show with the id "warning.bountifulfares.fermentation_vessel.[COLLECTOR ITEM ID]", you can add a translation to this in a lang file.
