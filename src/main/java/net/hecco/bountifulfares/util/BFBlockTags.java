...
public class BFBlockTags {
    public static final TagKey<Block> IGNORE_PARTICLE_TINT = TagKey.of(RegistryKeys.BLOCK, Identifier.of(BountifulFares.MOD_ID, "ignore_particle_tint"));
    public static final TagKey<Block> INFUSED_CANDLES = TagKey.of(RegistryKeys.BLOCK, Identifier.of(BountifulFares.MOD_ID, "infused_candles"));
    public static final TagKey<Block> APPLE_LEAVES = TagKey.of(RegistryKeys.BLOCK, Identifier.of(BountifulFares.MOD_ID, "apple_leaves"));
    ...
    public static final TagKey<Block> PLUM_LOGS = TagKey.of(RegistryKeys.BLOCK, Identifier.of(BountifulFares.MOD_ID, "plum_logs"));
    ...
    public static final TagKey<Block> DYEABLE_CERAMIC_BLOCKS = TagKey.of(RegistryKeys.BLOCK, Identifier.of(BountifulFares.MOD_ID, "dyeable_ceramic_blocks"));
    public static final TagKey<Block> FELSIC_STONES = TagKey.of(RegistryKeys.BLOCK, Identifier.of(BountifulFares.MOD_ID, "felsic_stones"));
