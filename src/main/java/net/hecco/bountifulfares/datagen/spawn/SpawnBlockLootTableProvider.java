...
public class SpawnBlockLootTableProvider extends FabricBlockLootTableProvider {
    public SpawnBlockLootTableProvider(FabricDataOutput dataOutput, CompletableFuture<RegistryWrapper.WrapperLookup> registryLookup) {
    ...
    public void generate() {
        ...
        for(Identifier id : BountifulFaresUtil.allBlockIdsInNamespace(BountifulFares.SPAWN_MOD_ID)) {
