...
public class TwigsBlockLootTableProvider extends FabricBlockLootTableProvider {
    protected TwigsBlockLootTableProvider(FabricDataOutput dataOutput, CompletableFuture<RegistryWrapper.WrapperLookup> registryLookup) {
    ...
    public void generate() {
        for(Identifier id : BountifulFaresUtil.allBlockIdsInNamespace(BountifulFares.TWIGS_MOD_ID)) {
