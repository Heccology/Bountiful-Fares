...
public class ArtsAndCraftsBlockLootTableProvider extends FabricBlockLootTableProvider {
    public ArtsAndCraftsBlockLootTableProvider(FabricDataOutput dataOutput, CompletableFuture<RegistryWrapper.WrapperLookup> registryLookup) {
    ...
    public void generate() {
        ...
        for(Identifier id : BountifulFaresUtil.allBlockIdsInNamespace(BountifulFares.ARTS_AND_CRAFTS_MOD_ID)) {
