...
public class BFItemTagProvider extends FabricTagProvider.ItemTagProvider {
    ...
    protected void configure(RegistryWrapper.WrapperLookup arg) {
        ...
        ;
        getOrCreateTagBuilder(BFItemTags.EATABLE_ON_DISH)
                .addOptional(Identifier.of(EXCESSIVE_BUILDING_MOD_ID, "ancient_fruit"));

//        Mint
        getOrCreateTagBuilder(BFItemTags.EATABLE_ON_DISH)
            .addOptional(Identifier.of(ELS_AND_LS_DYES_MOD_ID, "mint_sprig"))
            .addOptional(Identifier.of(ELS_AND_LS_DYES_MOD_ID, "mint_cookie"))
            .addOptional(Identifier.of(ELS_AND_LS_DYES_MOD_ID, "wintergreen_berries"))
            .addOptional(Identifier.of(ELS_AND_LS_DYES_MOD_ID, "winter_medley"))
            .addOptional(Identifier.of(ELS_AND_LS_DYES_MOD_ID, "wintergreen_candy_cane"))
            .addOptional(Identifier.of(ELS_AND_LS_DYES_MOD_ID, "peppermint_candy_cane"))
            .addOptional(Identifier.of(ELS_AND_LS_DYES_MOD_ID, "lavender_bread"))
            .addOptional(Identifier.of(ELS_AND_LS_DYES_MOD_ID, "peach"))
            .addOptional(Identifier.of(ELS_AND_LS_DYES_MOD_ID, "peach_slice"))
            .addOptional(Identifier.of(ELS_AND_LS_DYES_MOD_ID, "golden_peach"))
            .addOptional(Identifier.of(ELS_AND_LS_DYES_MOD_ID, "peach_cobbler"))
            .addOptional(Identifier.of(ELS_AND_LS_DYES_MOD_ID, "cooked_anemone"))
            .addOptional(Identifier.of(ELS_AND_LS_DYES_MOD_ID, "artichoke"))
            .addOptional(Identifier.of(ELS_AND_LS_DYES_MOD_ID, "artichoke_heart"))
            .addOptional(Identifier.of(ELS_AND_LS_DYES_MOD_ID, "artichoke_lamb"))
            .addOptional(Identifier.of(ELS_AND_LS_DYES_MOD_ID, "breakfast_porkchop"))
            .addOptional(Identifier.of(ELS_AND_LS_DYES_MOD_ID, "pineapple_slices"))
            .addOptional(Identifier.of(ELS_AND_LS_DYES_MOD_ID, "pineapple_tart"))
            .addOptional(Identifier.of(ELS_AND_LS_DYES_MOD_ID, "pineapple_kebab"))
            .addOptional(Identifier.of(ELS_AND_LS_DYES_MOD_ID, "strawberry"))
            .addOptional(Identifier.of(ELS_AND_LS_DYES_MOD_ID, "chocolate_strawberry"))
            .addOptional(Identifier.of(ELS_AND_LS_DYES_MOD_ID, "golden_strawberry"))
            .addOptional(Identifier.of(ELS_AND_LS_DYES_MOD_ID, "strawberry_shortcake"))
            .addOptional(Identifier.of(ELS_AND_LS_DYES_MOD_ID, "strawberry_cheesecake"))
            .addOptional(Identifier.of(ELS_AND_LS_DYES_MOD_ID, "angel_food_cake"))
            .addOptional(Identifier.of(ELS_AND_LS_DYES_MOD_ID, "cherries"))
            .addOptional(Identifier.of(ELS_AND_LS_DYES_MOD_ID, "cherry_pie"))
            .addOptional(Identifier.of(ELS_AND_LS_DYES_MOD_ID, "pokeberries"))
        ;

        //        Farmersdelight
        getOrCreateTagBuilder(BFItemTags.EATABLE_ON_DISH)
                .addOptional(Identifier.of(FARMERS_DELIGHT_MOD_ID, "cabbage"))
                .addOptional(Identifier.of(FARMERS_DELIGHT_MOD_ID, "tomato"))
                .addOptional(Identifier.of(FARMERS_DELIGHT_MOD_ID, "onion"))
                .addOptional(Identifier.of(FARMERS_DELIGHT_MOD_ID, "fried_egg"))
                .addOptional(Identifier.of(FARMERS_DELIGHT_MOD_ID, "pumpkin_slice"))
                .addOptional(Identifier.of(FARMERS_DELIGHT_MOD_ID, "cabbage_leaf"))
                .addOptional(Identifier.of(FARMERS_DELIGHT_MOD_ID, "minced_beef"))
                .addOptional(Identifier.of(FARMERS_DELIGHT_MOD_ID, "beef_patty"))
                .addOptional(Identifier.of(FARMERS_DELIGHT_MOD_ID, "chicken_cuts"))
                .addOptional(Identifier.of(FARMERS_DELIGHT_MOD_ID, "cooked_chicken_cuts"))
                .addOptional(Identifier.of(FARMERS_DELIGHT_MOD_ID, "bacon"))
                .addOptional(Identifier.of(FARMERS_DELIGHT_MOD_ID, "cooked_bacon"))
                .addOptional(Identifier.of(FARMERS_DELIGHT_MOD_ID, "cod_slice"))
                .addOptional(Identifier.of(FARMERS_DELIGHT_MOD_ID, "cooked_cod_slice"))
                .addOptional(Identifier.of(FARMERS_DELIGHT_MOD_ID, "salmon_slice"))
                .addOptional(Identifier.of(FARMERS_DELIGHT_MOD_ID, "cooked_salmon_slice"))
                .addOptional(Identifier.of(FARMERS_DELIGHT_MOD_ID, "mutton_chops"))
                .addOptional(Identifier.of(FARMERS_DELIGHT_MOD_ID, "cooked_mutton_chops"))
                .addOptional(Identifier.of(FARMERS_DELIGHT_MOD_ID, "ham"))
                .addOptional(Identifier.of(FARMERS_DELIGHT_MOD_ID, "smoked_ham"))
                .addOptional(Identifier.of(FARMERS_DELIGHT_MOD_ID, "pie_crust"))
                .addOptional(Identifier.of(FARMERS_DELIGHT_MOD_ID, "apple_pie"))
                .addOptional(Identifier.of(FARMERS_DELIGHT_MOD_ID, "sweet_berry_cheesecake_slice"))
                .addOptional(Identifier.of(FARMERS_DELIGHT_MOD_ID, "chocolate_pie_slice"))
                .addOptional(Identifier.of(FARMERS_DELIGHT_MOD_ID, "sweet_berry_cookie"))
                .addOptional(Identifier.of(FARMERS_DELIGHT_MOD_ID, "honey_cookie"))
                .addOptional(Identifier.of(FARMERS_DELIGHT_MOD_ID, "melon_popsicle"))
                .addOptional(Identifier.of(FARMERS_DELIGHT_MOD_ID, "egg_sandwich"))
                .addOptional(Identifier.of(FARMERS_DELIGHT_MOD_ID, "chicken_sandwich"))
                .addOptional(Identifier.of(FARMERS_DELIGHT_MOD_ID, "hamburger"))
                .addOptional(Identifier.of(FARMERS_DELIGHT_MOD_ID, "bacon_sandwich"))
                .addOptional(Identifier.of(FARMERS_DELIGHT_MOD_ID, "mutton_wrap"))
                .addOptional(Identifier.of(FARMERS_DELIGHT_MOD_ID, "dumplings"))
                .addOptional(Identifier.of(FARMERS_DELIGHT_MOD_ID, "stuffed_potato"))
                .addOptional(Identifier.of(FARMERS_DELIGHT_MOD_ID, "cabbage_rolls"))
                .addOptional(Identifier.of(FARMERS_DELIGHT_MOD_ID, "salmon_roll"))
                .addOptional(Identifier.of(FARMERS_DELIGHT_MOD_ID, "cod_roll"))
                .addOptional(Identifier.of(FARMERS_DELIGHT_MOD_ID, "kelp_roll"))
                .addOptional(Identifier.of(FARMERS_DELIGHT_MOD_ID, "kelp_roll_slice"))
                .addOptional(Identifier.of(FARMERS_DELIGHT_MOD_ID, "wheat_dough"))
                .addOptional(Identifier.of(FARMERS_DELIGHT_MOD_ID, "raw_pasta"))
        ;
