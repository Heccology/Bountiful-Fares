    ...
    public void generateAdvancement(Consumer<AdvancementEntry> consumer) {
        AdvancementEntry root_advancement = Advancement.Builder.create()
                .display(new AdvancementDisplay(new ItemStack(BFItems.PASSION_FRUIT),
                        ...
                        Text.translatable("advancement.bountifulfares.bountiful_fares.description"), Optional.of(new Identifier("minecraft:textures/block/farmland_moist.png")), AdvancementFrame.TASK,
                        false,
                        false,
                        false))
        ...
        AdvancementEntry make_first_food = Advancement.Builder.create()
                .display(new AdvancementDisplay(new ItemStack(BFItems.BOUNTIFUL_STEW),
                        ...
                        Text.translatable("advancement.bountifulfares.make_first_food.description"), Optional.of(new Identifier("minecraft:textures/block/farmland_moist.png")), AdvancementFrame.TASK,
                        true,
                        true,
                        false))
        ...
        AdvancementEntry eat_all_food = Advancement.Builder.create()
                .display(new AdvancementDisplay(new ItemStack(BFItems.CRUSTED_BEEF),
                        ...
                        Text.translatable("advancement.bountifulfares.eat_all_food.description"), Optional.of(new Identifier("minecraft:textures/block/farmland_moist.png")), AdvancementFrame.GOAL,
                        true,
                        true,
                        false))
        ...
        AdvancementEntry place_gristmill = Advancement.Builder.create()
                .display(new AdvancementDisplay(new ItemStack(BFBlocks.GRISTMILL),
                        ...
                        Text.translatable("advancement.bountifulfares.place_gristmill.description"), Optional.of(new Identifier("minecraft:textures/block/farmland_moist.png")), AdvancementFrame.TASK,
                        true,
                        true,
                        false))
                .parent(root_advancement)
        ...
        AdvancementEntry obtain_feldspar = Advancement.Builder.create()
                .display(new AdvancementDisplay(new ItemStack(BFItems.FELDSPAR),
                        ...
                        Text.translatable("advancement.bountifulfares.obtain_feldspar.description"), Optional.of(new Identifier("minecraft:textures/block/farmland_moist.png")), AdvancementFrame.TASK,
                        true,
                        true,
                        false))
        ...
        AdvancementEntry obtain_ceramic_tiles = Advancement.Builder.create()
                .display(new AdvancementDisplay(new ItemStack(BFBlocks.CERAMIC_TILES),
                        ...
                        Text.translatable("advancement.bountifulfares.obtain_ceramic_tiles.description"), Optional.of(new Identifier("minecraft:textures/block/farmland_moist.png")), AdvancementFrame.TASK,
                        true,
                        true,
                        false))
        ...
        AdvancementEntry obtain_fermentation_vessel = Advancement.Builder.create()
                .display(new AdvancementDisplay(new ItemStack(BFBlocks.FERMENTATION_VESSEL),
                        ...
                        Text.translatable("advancement.bountifulfares.obtain_fermentation_vessel.description"), Optional.of(new Identifier("minecraft:textures/block/farmland_moist.png")), AdvancementFrame.TASK,
                        true,
                        true,
                        false))
                .parent(obtain_feldspar)
        ...
        AdvancementEntry eat_ancient_fruit = Advancement.Builder.create()
                .display(new AdvancementDisplay(new ItemStack(BFItems.HOARY_APPLE),
                        ...
                        Text.translatable("advancement.bountifulfares.eat_ancient_fruit.description"), Optional.of(new Identifier("minecraft:textures/block/farmland_moist.png")), AdvancementFrame.TASK,
                        true,
                        true,
                        false))
                .parent(root_advancement)
        ...
        AdvancementEntry place_all_baked_goods = Advancement.Builder.create()
                .display(new AdvancementDisplay(new ItemStack(BFBlocks.ARTISAN_BREAD),
                        ...
                        Text.translatable("advancement.bountifulfares.place_all_baked_goods.description"), Optional.of(new Identifier("minecraft:textures/block/farmland_moist.png")), AdvancementFrame.CHALLENGE,
                        true,
                        true,
                        false))
                .parent(root_advancement)
...
//                        Text.translatable("advancement.bountifulfares.throw_flour.description"), Optional.of(new Identifier("minecraft:textures/block/farmland_moist.png")), AdvancementFrame.TASK,
//                        true,
//                        true,
//                        false))
//                .parent(place_gristmill)
...
//                .build(consumer, BountifulFares.MOD_ID + ":throw_flour");
        AdvancementEntry obtain_sun_hat = Advancement.Builder.create()
                .display(new AdvancementDisplay(new ItemStack(BFItems.SUN_HAT),
                        ...
                        Text.translatable("advancement.bountifulfares.obtain_sun_hat.description"), Optional.of(new Identifier("minecraft:textures/block/farmland_moist.png")), AdvancementFrame.TASK,
                        true,
                        true,
                        false))
                .parent(root_advancement)
        ...
        AdvancementEntry eat_all_candy = Advancement.Builder.create()
                .display(new AdvancementDisplay(new ItemStack(BFItems.CANDY),
                        ...
                        Text.translatable("advancement.bountifulfares.eat_all_candy.description"), Optional.of(new Identifier("minecraft:textures/block/farmland_moist.png")), AdvancementFrame.TASK,
                        true,
                        true,
                        false))
                .parent(root_advancement)
...
//                        Text.translatable("advancement.bountifulfares.gorge.description"), Optional.of(new Identifier("minecraft:textures/block/farmland_moist.png")), AdvancementFrame.TASK,
//                        true,
//                        true,
//                        false))
...
//                .build(consumer, BountifulFares.MOD_ID + ":gorge");
        AdvancementEntry obtain_tea_blends = Advancement.Builder.create()
                .display(new AdvancementDisplay(new ItemStack(BFItems.TEA_LEAVES),
                        ...
                        Text.translatable("advancement.bountifulfares.obtain_tea_blends.description"), Optional.of(new Identifier("minecraft:textures/block/farmland_moist.png")), AdvancementFrame.CHALLENGE,
                        true,
                        true,
                        false))
                .parent(place_gristmill)
        ...
        AdvancementEntry place_all_tea_candles = Advancement.Builder.create()
                .display(new AdvancementDisplay(new ItemStack(BFBlocks.GREEN_TEA_CANDLE),
                        ...
                        Text.translatable("advancement.bountifulfares.place_all_tea_candles.description"), Optional.of(new Identifier("minecraft:textures/block/farmland_moist.png")), AdvancementFrame.CHALLENGE,
                        true,
                        true,
                        false))
        ...
        AdvancementEntry obtain_walnut = Advancement.Builder.create()
                .display(new AdvancementDisplay(new ItemStack(BFItems.WALNUT),
                        ...
                        Text.translatable("advancement.bountifulfares.obtain_walnut.description"), Optional.of(new Identifier("minecraft:textures/block/farmland_moist.png")), AdvancementFrame.TASK,
                        true,
                        true,
                        false))
                .parent(root_advancement)
        ...
        AdvancementEntry obtain_spongekin_seeds = Advancement.Builder.create()
                .display(new AdvancementDisplay(new ItemStack(BFItems.SPONGEKIN_SEEDS),
                        ...
                        Text.translatable("advancement.bountifulfares.obtain_spongekin_seeds.description"), Optional.of(new Identifier("minecraft:textures/block/farmland_moist.png")), AdvancementFrame.TASK,
                        true,
                        true,
                        false))
                .parent(root_advancement)
        ...
        AdvancementEntry obtain_spongekin = Advancement.Builder.create()
                .display(new AdvancementDisplay(new ItemStack(BFBlocks.SPONGEKIN),
                        ...
                        Text.translatable("advancement.bountifulfares.obtain_spongekin.description"), Optional.of(new Identifier("minecraft:textures/block/farmland_moist.png")), AdvancementFrame.TASK,
                        true,
                        true,
                        false))
...
//                        Text.translatable("advancement.bountifulfares.breed_wolves_with_mulch.description"), Optional.of(new Identifier("minecraft:textures/block/farmland_moist.png")), AdvancementFrame.CHALLENGE,
//                        true,
//                        true,
//                        false))
//                .parent(obtain_feldspar)
