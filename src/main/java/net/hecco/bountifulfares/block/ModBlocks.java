...
import net.hecco.bountifulfares.util.ModBlockSetTypes;
...
public class ModBlocks {
    ...
    public static final Block CRACKED_CERAMIC_TILES = registerDyeableCeramicBlock("cracked_ceramic_tiles", new CeramicTilesBlock(FabricBlockSettings.copyOf(ModBlocks.CERAMIC_TILES)));
    ...
    public static final Block CRACKED_CHECKERED_CERAMIC_TILES = registerDyeableCeramicBlock("cracked_checkered_ceramic_tiles", new CeramicTilesBlock(FabricBlockSettings.copyOf(ModBlocks.CERAMIC_TILES)));
    public static final Block CERAMIC_TILE_PILLAR = registerDyeableCeramicBlock("ceramic_tile_pillar", new CeramicTilePillarBlock(FabricBlockSettings.copyOf(ModBlocks.CERAMIC_TILES)));
    public static final Block CERAMIC_MOSAIC = registerDyeableCeramicBlock("ceramic_mosaic", new CeramicTilesBlock(FabricBlockSettings.create().solidBlock(Blocks::never).requiresTool().strength(2f, 16f).sounds(ModSounds.CERAMIC_TILES).instrument(Instrument.HAT).mapColor(MapColor.OFF_WHITE)));
    public static final Block CERAMIC_MOSAIC_STAIRS = registerDyeableCeramicBlock("ceramic_mosaic_stairs", new CeramicTileStairsBlock(ModBlocks.CERAMIC_MOSAIC.getDefaultState(), FabricBlockSettings.copyOf(ModBlocks.CERAMIC_MOSAIC)));
    public static final Block CERAMIC_MOSAIC_SLAB = registerDyeableCeramicBlock("ceramic_mosaic_slab", new CeramicTileSlabBlock(FabricBlockSettings.copyOf(ModBlocks.CERAMIC_MOSAIC)));
    public static final Block CHECKERED_CERAMIC_MOSAIC = registerDyeableCeramicBlock("checkered_ceramic_mosaic", new CeramicTilesBlock(FabricBlockSettings.copyOf(ModBlocks.CERAMIC_MOSAIC)));
    public static final Block CHECKERED_CERAMIC_MOSAIC_STAIRS = registerDyeableCeramicBlock("checkered_ceramic_mosaic_stairs", new CeramicTileStairsBlock(ModBlocks.CHECKERED_CERAMIC_MOSAIC.getDefaultState(), FabricBlockSettings.copyOf(ModBlocks.CHECKERED_CERAMIC_MOSAIC)));
    public static final Block CHECKERED_CERAMIC_MOSAIC_SLAB = registerDyeableCeramicBlock("checkered_ceramic_mosaic_slab", new CeramicTileSlabBlock(FabricBlockSettings.copyOf(ModBlocks.CHECKERED_CERAMIC_MOSAIC)));
    ...
    public static final Block CERAMIC_DOOR = registerDyeableCeramicBlock("ceramic_door", new CeramicDoorBlock(FabricBlockSettings.create().solidBlock(Blocks::never).requiresTool().strength(2f, 16f).sounds(ModSounds.CERAMIC_DECORATION).instrument(Instrument.HAT).mapColor(MapColor.OFF_WHITE), ModBlockSetTypes.CERAMIC));
