...
public class ModBlocks {
    ...
    public static final Block TEST_TRELLIS = registerBlock("test_trellis", new TestTrellisBlock(FabricBlockSettings.create().nonOpaque().strength(0.5F).sounds(ModSounds.LIGHT_WOOD).instrument(Instrument.BASS).nonOpaque()));
    public static final Block PASSION_FRUIT_VINE = registerBlockNoItem("passion_fruit_vine", new Block(FabricBlockSettings.create()));
