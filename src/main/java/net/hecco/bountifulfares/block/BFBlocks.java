...
public class BFBlocks {
    ...
    public static final Block APPLE_LOG = registerBlock("apple_log", new FruitLogBlock(FabricBlockSettings.copyOf(Blocks.OAK_LOG).nonOpaque().notSolid()));
    public static final Block APPLE_WOOD = registerBlock("apple_wood", new FruitLogBlock(FabricBlockSettings.copyOf(Blocks.OAK_WOOD).nonOpaque().notSolid()));
    ...
    public static final Block ORANGE_LOG = registerBlock("orange_log", new FruitLogBlock(FabricBlockSettings.copyOf(BFBlocks.APPLE_LOG)));
    public static final Block ORANGE_WOOD = registerBlock("orange_wood", new FruitLogBlock(FabricBlockSettings.copyOf(BFBlocks.APPLE_WOOD)));
    ...
    public static final Block LEMON_LOG = registerBlock("lemon_log", new FruitLogBlock(FabricBlockSettings.copyOf(BFBlocks.APPLE_LOG)));
    public static final Block LEMON_WOOD = registerBlock("lemon_wood", new FruitLogBlock(FabricBlockSettings.copyOf(BFBlocks.APPLE_WOOD)));
    ...
    public static final Block PLUM_LOG = registerBlock("plum_log", new FruitLogBlock(FabricBlockSettings.copyOf(BFBlocks.APPLE_LOG)));
    public static final Block PLUM_WOOD = registerBlock("plum_wood", new FruitLogBlock(FabricBlockSettings.copyOf(BFBlocks.APPLE_WOOD)));
    ...
    public static final Block COIR_BRICKS = registerBlock("coir_bricks", new Block(FabricBlockSettings.create().mapColor(MapColor.OAK_TAN).instrument(Instrument.BASEDRUM).requiresTool().strength(0.5F, 1.0F).sounds(BlockSoundGroup.PACKED_MUD)));
    public static final Block COIR_BRICK_SLAB = registerBlock("coir_brick_slab", new SlabBlock(FabricBlockSettings.create().mapColor(MapColor.OAK_TAN).instrument(Instrument.BASEDRUM).requiresTool().strength(0.5F, 1.0F).sounds(BlockSoundGroup.PACKED_MUD)));
    public static final Block COIR_BRICK_STAIRS = registerBlock("coir_brick_stairs", new ModStairsBlock(COIR_BRICKS.getDefaultState(), FabricBlockSettings.create().mapColor(MapColor.OAK_TAN).instrument(Instrument.BASEDRUM).requiresTool().strength(0.5F, 1.0F).sounds(BlockSoundGroup.PACKED_MUD)));
    public static final Block COIR_BRICK_WALL = registerBlock("coir_brick_wall", new WallBlock(FabricBlockSettings.create().mapColor(MapColor.OAK_TAN).instrument(Instrument.BASEDRUM).requiresTool().strength(0.5F, 1.0F).sounds(BlockSoundGroup.PACKED_MUD)));
