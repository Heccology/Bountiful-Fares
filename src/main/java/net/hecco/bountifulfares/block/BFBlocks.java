...
public class BFBlocks {
    ...
    public static final Block PALM_SAPLING = registerBlockNoItem("palm_sapling", new SaplingBlock(BFSaplingGenerators.PALM, FabricBlockSettings.copyOf(Blocks.OAK_SAPLING)));
