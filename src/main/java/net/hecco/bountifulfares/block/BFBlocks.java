...
public class BFBlocks {
    ...
    public static final Block CERAMIC_TILES = registerDyeableCeramicBlock("ceramic_tiles", new CeramicTilesBlock(AbstractBlock.Settings.create().solidBlock(Blocks::never).requiresTool().strength(2f, 16f).sounds(BFSounds.CERAMIC_TILES).instrument(NoteBlockInstrument.HAT).mapColor(MapColor.OFF_WHITE)));
    ...
    public static final Block CERAMIC_MOSAIC = registerDyeableCeramicBlock("ceramic_mosaic", new CeramicTilesBlock(AbstractBlock.Settings.create().solidBlock(Blocks::never).requiresTool().strength(2f, 16f).sounds(BFSounds.CERAMIC_TILES).instrument(NoteBlockInstrument.HAT).mapColor(MapColor.OFF_WHITE)));
    ...
    public static final Block CERAMIC_PRESSURE_PLATE = registerDyeableCeramicBlock("ceramic_pressure_plate", new CeramicPressurePlateBlock(AbstractBlock.Settings.create().mapColor(MapColor.OFF_WHITE).solid().sounds(BFSounds.CERAMIC_DECORATION).instrument(NoteBlockInstrument.HAT).noCollision().strength(0.5F).pistonBehavior(PistonBehavior.DESTROY), BFBlockSetTypes.CERAMIC));
    ...
    public static final Block CERAMIC_LEVER = registerDyeableCeramicBlock("ceramic_lever", new CeramicLeverBlock(AbstractBlock.Settings.create().mapColor(MapColor.OFF_WHITE).solid().sounds(BFSounds.CERAMIC_DECORATION).instrument(NoteBlockInstrument.HAT).noCollision().strength(0.5F).pistonBehavior(PistonBehavior.DESTROY)));
    ...
    public static final Block CERAMIC_DOOR = registerDyeableCeramicBlock("ceramic_door", new CeramicDoorBlock(AbstractBlock.Settings.create().solidBlock(Blocks::never).requiresTool().strength(2f, 16f).sounds(BFSounds.CERAMIC_DECORATION).instrument(NoteBlockInstrument.HAT).mapColor(MapColor.OFF_WHITE), BFBlockSetTypes.CERAMIC));
    public static final Block CERAMIC_TRAPDOOR = registerDyeableCeramicBlock("ceramic_trapdoor", new CeramicTrapdoorBlock(AbstractBlock.Settings.create().solidBlock(Blocks::never).requiresTool().strength(2f, 16f).sounds(BFSounds.CERAMIC_DECORATION).instrument(NoteBlockInstrument.HAT).mapColor(MapColor.OFF_WHITE), BFBlockSetTypes.CERAMIC));


    public static final Block FERMENTATION_VESSEL = registerBlock("fermentation_vessel", new FermentationVesselBlock(AbstractBlock.Settings.create().mapColor(MapColor.OFF_WHITE).strength(2, 5).instrument(NoteBlockInstrument.BASEDRUM).requiresTool().nonOpaque().sounds(BFSounds.CERAMIC_DECORATION)));
    ...
    public static final Block HOARY_APPLE_BLOCK = registerBlock("hoary_apple_block", new HoaryAppleBlock(AbstractBlock.Settings.create().mapColor(MapColor.TERRACOTTA_GRAY).strength(0.5f).instrument(NoteBlockInstrument.DIDGERIDOO).sounds(BlockSoundGroup.WOOD)));
    ...
    public static final Block SPONGEKIN = registerBlock("spongekin", new SpongekinBlock(AbstractBlock.Settings.create().mapColor(MapColor.BRIGHT_TEAL).instrument(NoteBlockInstrument.DIDGERIDOO).strength(1.0f).sounds(BFSounds.SPONGEKIN).pistonBehavior(PistonBehavior.DESTROY)));
