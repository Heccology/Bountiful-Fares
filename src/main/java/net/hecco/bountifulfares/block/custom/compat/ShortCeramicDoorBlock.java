...
public class ShortCeramicDoorBlock extends ShortDoorBlock implements DyeableCeramicBlockInterface {
    private final BlockSetType blockSetType;
    public ShortCeramicDoorBlock(Settings settings, BlockSetType blockSetType) {
        ...
        if (!world.isClient) {
            ...
            if (bl != state.get(POWERED)) {
                if (!state.get(POWERED)) {
                    ...
                    world.playSound(null, pos, bl ? this.blockSetType.doorOpen() : this.blockSetType.doorClose(), SoundCategory.BLOCKS, 1.0F, world.getRandom().nextFloat() * 0.1F + 0.9F);
