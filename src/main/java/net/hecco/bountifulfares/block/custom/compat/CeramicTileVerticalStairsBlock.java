...
public class CeramicTileVerticalStairsBlock extends VerticalStairsBlock implements DyeableCeramicBlockInterface {
    public CeramicTileVerticalStairsBlock(Settings settings) {
        super(settings);
