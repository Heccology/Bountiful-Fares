...
public class OrangeLogBlock extends FruitLogBlock {
    public OrangeLogBlock(Block leaves, Block floweringleaves, Settings settings) {
    ...
    protected boolean shouldBeLeafy(WorldView world, BlockPos pos, BlockState blockState) {
        ...
        for (Direction direction : directions) {
            ...
            if (neighborState.getBlock() != BFBlocks.ORANGE_LEAVES && neighborState.getBlock() != BFBlocks.FLOWERING_ORANGE_LEAVES) {
                return false;
            }
        }
