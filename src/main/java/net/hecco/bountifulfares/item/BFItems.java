...
public class BFItems {
    ...
    public static final Item COASTAL_MEDLEY = registerItem("coastal_medley", new Item(new FabricItemSettings().maxCount(16).food(new FoodComponent.Builder().hunger(12).saturationModifier(0.6F).statusEffect(new StatusEffectInstance(BFEffects.ENRICHMENT, 1200, 0, true, true), 1).build())));
    ...
    public static final Item GLOWING_CUSTARD = registerItem("glowing_custard", new StackableBowlFoodItem(new FabricItemSettings().maxCount(16).food(new FoodComponent.Builder().hunger(8).saturationModifier(0.8F).statusEffect(new StatusEffectInstance(BFEffects.RESTORATION, 1800, 0, true, true), 1).build())));
