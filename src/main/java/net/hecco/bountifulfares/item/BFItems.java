...
public class BFItems {
    ...
    public static final Item APPLE_COMPOTE_JAR = registerItem("apple_compote_jar", new EdibleJarItem(new FabricItemSettings().maxCount(16).food(new FoodComponent.Builder().hunger(6).saturationModifier(0.4f).statusEffect(new StatusEffectInstance(StatusEffects.SPEED, 200, 0), 1f).build()).recipeRemainder(BFItems.JAR)));
    public static final Item ORANGE_COMPOTE_JAR = registerItem("orange_compote_jar", new EdibleJarItem(new FabricItemSettings().maxCount(16).food(new FoodComponent.Builder().hunger(6).saturationModifier(0.4f).statusEffect(new StatusEffectInstance(StatusEffects.SPEED, 200, 0), 1f).build()).recipeRemainder(BFItems.JAR)));
    public static final Item LEMON_COMPOTE_JAR = registerItem("lemon_compote_jar", new EdibleJarItem(new FabricItemSettings().maxCount(16).food(new FoodComponent.Builder().hunger(6).saturationModifier(0.4f).statusEffect(new StatusEffectInstance(StatusEffects.SPEED, 200, 0), 1f).build()).recipeRemainder(BFItems.JAR)));
    public static final Item PLUM_COMPOTE_JAR = registerItem("plum_compote_jar", new EdibleJarItem(new FabricItemSettings().maxCount(16).food(new FoodComponent.Builder().hunger(6).saturationModifier(0.4f).statusEffect(new StatusEffectInstance(StatusEffects.SPEED, 200, 0), 1f).build()).recipeRemainder(BFItems.JAR)));
    public static final Item HOARY_COMPOTE_JAR = registerItem("hoary_compote_jar", new EdibleJarItem(new FabricItemSettings().maxCount(16).food(new FoodComponent.Builder().hunger(6).saturationModifier(0.4f).statusEffect(new StatusEffectInstance(StatusEffects.SPEED, 200, 0), 1f).build()).recipeRemainder(BFItems.JAR)));
    ...
    public static final Item CUSTARD = registerItem("custard", new StackableBowlFoodItem(new FabricItemSettings().maxCount(16).food(new FoodComponent.Builder().hunger(8).saturationModifier(0.8F).statusEffect(new StatusEffectInstance(BFEffects.RESTORATION, 1800, 0, true, true), 1).build()).recipeRemainder(Items.BOWL)));
    public static final Item PIQUANT_CUSTARD = registerItem("piquant_custard", new StackableBowlFoodItem(new FabricItemSettings().maxCount(16).food(new FoodComponent.Builder().hunger(8).saturationModifier(0.8F).statusEffect(new StatusEffectInstance(BFEffects.RESTORATION, 1800, 0, true, true), 1).build()).recipeRemainder(Items.BOWL)));
    public static final Item PASSION_CUSTARD = registerItem("passion_custard", new StackableBowlFoodItem(new FabricItemSettings().maxCount(16).food(new FoodComponent.Builder().hunger(8).saturationModifier(0.8F).statusEffect(new StatusEffectInstance(BFEffects.RESTORATION, 1800, 0, true, true), 1).build()).recipeRemainder(Items.BOWL)));
    public static final Item COCOA_CUSTARD = registerItem("cocoa_custard", new StackableBowlFoodItem(new FabricItemSettings().maxCount(16).food(new FoodComponent.Builder().hunger(8).saturationModifier(0.8F).statusEffect(new StatusEffectInstance(BFEffects.RESTORATION, 1800, 0, true, true), 1).build()).recipeRemainder(Items.BOWL)));
    public static final Item ANCIENT_CUSTARD = registerItem("ancient_custard", new StackableBowlFoodItem(new FabricItemSettings().maxCount(16).food(new FoodComponent.Builder().hunger(8).saturationModifier(0.8F).statusEffect(new StatusEffectInstance(BFEffects.RESTORATION, 1800, 0, true, true), 1).build()).recipeRemainder(Items.BOWL)));
