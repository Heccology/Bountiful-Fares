...
public class BFItems {
    ...
    public static final Item HOARY_SEEDS = registerItem("hoary_seeds", new AliasedBlockItem(BFBlocks.HOARY_APPLE_SAPLING_CROP, new FabricItemSettings()));
    public static final Item HOARY_SIGN = registerItem("hoary_sign", new SignItem(new FabricItemSettings().maxCount(16), BFBlocks.HOARY_SIGN, BFBlocks.HOARY_WALL_SIGN));
    public static final Item HOARY_HANGING_SIGN = registerItem("hoary_hanging_sign", new HangingSignItem(BFBlocks.HOARY_HANGING_SIGN, BFBlocks.HOARY_WALL_HANGING_SIGN, new FabricItemSettings().maxCount(16)));
    ...
    public static final Item WALNUT_SIGN = registerItem("walnut_sign", new SignItem(new FabricItemSettings().maxCount(16), BFBlocks.WALNUT_SIGN, BFBlocks.WALNUT_WALL_SIGN));
    ...
    public static final Item CITRUS_ESSENCE = registerItem("citrus_essence", new Item(new FabricItemSettings().food(new FoodComponent.Builder().hunger(0).saturationModifier(0).snack().alwaysEdible().statusEffect(new StatusEffectInstance(BFEffects.ACIDIC, 300, 0),1).build())));
    ...
    public static final Item TEA_BERRIES = registerItem("tea_berries", new TeaBerriesItem(BFBlocks.TEA_SHRUB, new FabricItemSettings()));
    ...
    public static final Item GREEN_TEA_BOTTLE = registerItem("green_tea_bottle", new GreenTeaBottleItem(new FabricItemSettings().maxCount(16).food(new FoodComponent.Builder().hunger(6).saturationModifier(0.6f).statusEffect(new StatusEffectInstance(BFEffects.EBULLIENCE, 1800, 0, true, true), 1f).alwaysEdible().build())));
    public static final Item BLACK_TEA_BOTTLE = registerItem("black_tea_bottle", new BlackTeaBottleItem(new FabricItemSettings().maxCount(16).food(new FoodComponent.Builder().hunger(6).saturationModifier(0.6f).statusEffect(new StatusEffectInstance(BFEffects.EBULLIENCE, 1800, 0, true, true), 1f).alwaysEdible().build())));
    public static final Item CHAMOMILE_TEA_BOTTLE = registerItem("chamomile_tea_bottle", new ChamomileTeaBottleItem(new FabricItemSettings().maxCount(16).food(new FoodComponent.Builder().hunger(6).saturationModifier(0.6f).statusEffect(new StatusEffectInstance(BFEffects.EBULLIENCE, 1800, 0, true, true), 1f).alwaysEdible().build())));
    public static final Item HONEYSUCKLE_TEA_BOTTLE = registerItem("honeysuckle_tea_bottle", new HoneysuckleTeaBottleItem(new FabricItemSettings().maxCount(16).food(new FoodComponent.Builder().hunger(6).saturationModifier(0.6f).statusEffect(new StatusEffectInstance(BFEffects.EBULLIENCE, 1800, 0, true, true), 1f).alwaysEdible().build())));
    public static final Item BELLFLOWER_TEA_BOTTLE = registerItem("bellflower_tea_bottle", new BellflowerTeaBottleItem(new FabricItemSettings().maxCount(16).food(new FoodComponent.Builder().hunger(6).saturationModifier(0.6f).statusEffect(new StatusEffectInstance(BFEffects.EBULLIENCE, 1800, 0, true, true), 1f).alwaysEdible().build())));
    public static final Item TORCHFLOWER_TEA_BOTTLE = registerItem("torchflower_tea_bottle", new TorchflowerTeaBottleItem(new FabricItemSettings().maxCount(16).food(new FoodComponent.Builder().hunger(6).saturationModifier(0.6f).statusEffect(new StatusEffectInstance(BFEffects.EBULLIENCE, 1800, 0, true, true), 1f).alwaysEdible().build())));
    ...
    public static final Item MAIZE_SEEDS = registerItem("maize_seeds", new AliasedBlockItem(BFBlocks.MAIZE_CROP, new FabricItemSettings()));
    ...
    public static final Item LEEK_SEEDS = registerItem("leek_seeds", new AliasedBlockItem(BFBlocks.LEEKS, new FabricItemSettings()));
    public static final Item SPONGEKIN_SEEDS = registerItem("spongekin_seeds", new AliasedBlockItem(BFBlocks.SPONGEKIN_STEM, new FabricItemSettings()));
    public static final Item SPONGEKIN_SLICE = registerItem("spongekin_slice", new AirTimeIncreasingItem( 200, new FabricItemSettings().food(new FoodComponent.Builder().hunger(3).saturationModifier(0.3f).alwaysEdible().build())));
    public static final Item SCORCHKIN_SEEDS = registerItem("scorchkin_seeds", new AliasedBlockItem(BFBlocks.SCORCHKIN_STEM, new FabricItemSettings()));
    public static final Item FLOUR = registerItem("flour", new FlourItem(new FabricItemSettings()));
    public static final Item ARTISAN_COOKIE = registerItem("artisan_cookie", new AliasedBlockItem(BFBlocks.ARTISAN_COOKIES, new FabricItemSettings()));
    ...
    public static final Item SOUR_CANDY = registerItem("sour_candy", new Item(new FabricItemSettings().food(new FoodComponent.Builder().hunger(4).saturationModifier(0.4F).statusEffect(new StatusEffectInstance(BFEffects.ACIDIC, 200), 0.2f).snack().build())));
    ...
    public static final Item PASSION_GLAZED_SALMON = registerItem("passion_glazed_salmon", new StackableBowlFoodItem(new FabricItemSettings().maxCount(16).food(new FoodComponent.Builder().hunger(8).saturationModifier(0.7F).statusEffect(new StatusEffectInstance(BFEffects.ENRICHMENT, 2400, 0, true, true), 1).build())));
    public static final Item BOUNTIFUL_STEW = registerItem("bountiful_stew", new StackableBowlFoodItem(new FabricItemSettings().maxCount(16).food((new FoodComponent.Builder()).hunger(16).saturationModifier(0.7F).statusEffect(new StatusEffectInstance(BFEffects.RESTORATION, 2400, 0, true, true), 1).build())));
    public static final Item CRUSTED_BEEF = registerItem("crusted_beef", new StackableBowlFoodItem(new FabricItemSettings().maxCount(16).food(new FoodComponent.Builder().hunger(18).saturationModifier(0.7F).statusEffect(new StatusEffectInstance(BFEffects.ENRICHMENT, 2400, 0, true, true), 1).build())));
    public static final Item LEEK_STEW = registerItem("leek_stew", new StackableBowlFoodItem(new FabricItemSettings().maxCount(16).food(new FoodComponent.Builder().hunger(12).saturationModifier(0.7F).statusEffect(new StatusEffectInstance(BFEffects.ENRICHMENT, 1800, 0, true, true), 1).build())));
    public static final Item FISH_STEW = registerItem("fish_stew", new StackableBowlFoodItem(new FabricItemSettings().maxCount(16).food(new FoodComponent.Builder().hunger(14).saturationModifier(0.7F).statusEffect(new StatusEffectInstance(BFEffects.RESTORATION, 1800, 0, true, true), 1).build())));
    ...
    public static final Item APPLE_STEW = registerItem("apple_stew", new StackableBowlFoodItem(new FabricItemSettings().maxCount(16).food(new FoodComponent.Builder().hunger(14).saturationModifier(0.7F).statusEffect(new StatusEffectInstance(BFEffects.RESTORATION, 1800, 0, true, true), 1).build())));
    ...
    public static final Item COASTAL_MEDLEY = registerItem("coastal_medley", new AirTimeIncreasingItem(150, new FabricItemSettings().maxCount(16).food(new FoodComponent.Builder().hunger(12).saturationModifier(0.6F).statusEffect(new StatusEffectInstance(BFEffects.ENRICHMENT, 1200, 0, true, true), 1).build())));
    public static final Item CRIMSON_CHOW = registerItem("crimson_chow", new StackableBowlFoodItem(new FabricItemSettings().maxCount(16).food(new FoodComponent.Builder().hunger(12).saturationModifier(0.8F).build()).recipeRemainder(Items.BOWL)));
    public static final Item WARPED_CHOW = registerItem("warped_chow", new StackableBowlFoodItem(new FabricItemSettings().maxCount(16).food(new FoodComponent.Builder().hunger(10).saturationModifier(0.8F).build()).recipeRemainder(Items.BOWL)));
    public static final Item CUSTARD = registerItem("custard", new StackableBowlFoodItem(new FabricItemSettings().maxCount(16).food(new FoodComponent.Builder().hunger(8).saturationModifier(0.8F).statusEffect(new StatusEffectInstance(BFEffects.RESTORATION, 1800, 0, true, true), 1).build())));
    public static final Item PIQUANT_CUSTARD = registerItem("piquant_custard", new StackableBowlFoodItem(new FabricItemSettings().maxCount(16).food(new FoodComponent.Builder().hunger(8).saturationModifier(0.8F).statusEffect(new StatusEffectInstance(BFEffects.RESTORATION, 1800, 0, true, true), 1).build())));
    public static final Item PASSION_CUSTARD = registerItem("passion_custard", new StackableBowlFoodItem(new FabricItemSettings().maxCount(16).food(new FoodComponent.Builder().hunger(8).saturationModifier(0.8F).statusEffect(new StatusEffectInstance(BFEffects.RESTORATION, 1800, 0, true, true), 1).build())));
    public static final Item COCOA_CUSTARD = registerItem("cocoa_custard", new StackableBowlFoodItem(new FabricItemSettings().maxCount(16).food(new FoodComponent.Builder().hunger(8).saturationModifier(0.8F).statusEffect(new StatusEffectInstance(BFEffects.RESTORATION, 1800, 0, true, true), 1).build())));
    public static final Item ANCIENT_CUSTARD = registerItem("ancient_custard", new StackableBowlFoodItem(new FabricItemSettings().maxCount(16).food(new FoodComponent.Builder().hunger(8).saturationModifier(0.8F).statusEffect(new StatusEffectInstance(BFEffects.RESTORATION, 1800, 0, true, true), 1).build())));
    public static final Item MUSHROOM_STUFFED_POTATO = registerItem("mushroom_stuffed_potato", new Item(new FabricItemSettings().food(new FoodComponent.Builder().hunger(8).saturationModifier(0.8F).statusEffect(new StatusEffectInstance(BFEffects.ENRICHMENT, 1800, 0, true, true), 1).build())));
    public static final Item BERRY_STUFFED_POTATO = registerItem("berry_stuffed_potato", new Item(new FabricItemSettings().food(new FoodComponent.Builder().hunger(7).saturationModifier(0.8F).statusEffect(new StatusEffectInstance(BFEffects.ENRICHMENT, 1200, 0, true, true), 1).build())));
