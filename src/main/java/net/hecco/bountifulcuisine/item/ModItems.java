...
public class ModItems {
    ...
    public static final Item CITRIC_ACID = registerItem("citric_acid", new Item(new FabricItemSettings().food(new FoodComponent.Builder().hunger(0).saturationModifier(0).snack().statusEffect(new StatusEffectInstance(ModEffects.ACIDIC, 300, 0),1).build())));
