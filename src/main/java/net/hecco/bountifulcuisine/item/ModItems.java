...
public class ModItems {
    ...
    public static final Item WILD_WHEAT_SEEDS = registerItem("wild_wheat_seeds", new WildPlantItem(Blocks.WHEAT, new FabricItemSettings()));
    public static final Item WILD_BEETROOT_SEEDS = registerItem("wild_beetroot_seeds", new WildPlantItem(Blocks.BEETROOTS, new FabricItemSettings()));
