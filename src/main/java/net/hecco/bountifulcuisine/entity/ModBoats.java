...
public class ModBoats {
    ...
    public static final Identifier WALNUT_BOAT_ID = new Identifier(BountifulCuisine.MOD_ID, "walnut_boat");
    public static final Identifier WALNUT_CHEST_BOAT_ID = new Identifier(BountifulCuisine.MOD_ID, "walnut_chest_boat");
