...
public class ModBlocks {
    ...
    public static final Block CERAMIC_LEVER = registerDyeableCeramicBlock("ceramic_lever", new CeramicLeverBlock(FabricBlockSettings.create().mapColor(MapColor.OFF_WHITE).solid().sounds(ModSounds.CERAMIC_TILES).instrument(Instrument.HAT).requiresTool().noCollision().strength(0.5F).pistonBehavior(PistonBehavior.DESTROY)));
