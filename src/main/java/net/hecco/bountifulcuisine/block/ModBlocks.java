...
public class ModBlocks {
    ...
    public static final Block CERAMIC_TILES = registerDyeableCeramicBlock("ceramic_tiles", new CeramicTilesBlock(FabricBlockSettings.copyOf(Blocks.BRICKS).strength(2f, 16f).sounds(ModSounds.CERAMIC_TILES).instrument(Instrument.BASEDRUM).mapColor(MapColor.OFF_WHITE)));
    ...
    public static final Block GOLDEN_APPLE_BLOCK = registerBlock("golden_apple_block", new GoldenAppleBlock(FabricBlockSettings.create().mapColor(MapColor.YELLOW).strength(1f).instrument(Instrument.DIDGERIDOO).sounds(ModSounds.GOLDEN_APPLE_BLOCK).pistonBehavior(PistonBehavior.DESTROY)));
