...
public class ModBlocks {
    ...
    public static final Block CERAMIC_TILES = registerDyeableCeramicBlock("ceramic_tiles", new CeramicTilesBlock(FabricBlockSettings.create().requiresTool().strength(2f, 16f).sounds(ModSounds.CERAMIC_TILES).instrument(Instrument.BASEDRUM).mapColor(MapColor.OFF_WHITE)));
