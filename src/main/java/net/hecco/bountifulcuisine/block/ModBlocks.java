...
public class ModBlocks {
    ...
    public static final Block APPLE_BLOCK = registerPlantBlock("apple_block", new FruitBlock(FabricBlockSettings.create().mapColor(MapColor.RED).strength(1f).instrument(Instrument.DIDGERIDOO).sounds(BlockSoundGroup.WOOD).pistonBehavior(PistonBehavior.DESTROY)));
    ...
    public static final Block GIANT_ORANGE_BLOCK = registerPlantBlock("giant_orange_block", new FruitBlock(FabricBlockSettings.create().mapColor(MapColor.ORANGE).strength(0.5f).instrument(Instrument.DIDGERIDOO).requiresTool().sounds(BlockSoundGroup.WOOD)));
    public static final Block GIANT_LEMON_BLOCK = registerPlantBlock("giant_lemon_block", new PillarBlock(FabricBlockSettings.create().mapColor(MapColor.YELLOW).strength(0.5f).instrument(Instrument.DIDGERIDOO).requiresTool().sounds(BlockSoundGroup.WOOD)));
    public static final Block GIANT_PLUM_BLOCK = registerPlantBlock("giant_plum_block", new FruitBlock(FabricBlockSettings.create().mapColor(MapColor.DARK_DULL_PINK).strength(0.5f).instrument(Instrument.DIDGERIDOO).requiresTool().sounds(BlockSoundGroup.WOOD)));
