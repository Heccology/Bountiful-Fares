...
public class ModBlocks {
    ...
    public static final Block HOARY_FIG_SAPLING = registerBlock("hoary_fig_sapling", new PlantBlock(FabricBlockSettings.create().mapColor(MapColor.STONE_GRAY).noCollision().breakInstantly().sounds(BlockSoundGroup.CHERRY_SAPLING).pistonBehavior(PistonBehavior.DESTROY)));
