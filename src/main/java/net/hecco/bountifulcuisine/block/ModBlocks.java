...
public class ModBlocks {
    ...
    public static final Block GIANT_APPLE_BLOCK = registerBlock("giant_apple_block", new Block(FabricBlockSettings.create().mapColor(MapColor.RED).strength(0.5f).instrument(Instrument.DIDGERIDOO).requiresTool().nonOpaque().ticksRandomly().sounds(BlockSoundGroup.WOOD)));
    public static final Block GIANT_ORANGE_BLOCK = registerBlock("giant_orange_block", new Block(FabricBlockSettings.create().mapColor(MapColor.ORANGE).strength(0.5f).instrument(Instrument.DIDGERIDOO).requiresTool().nonOpaque().ticksRandomly().sounds(BlockSoundGroup.WOOD)));
    public static final Block GIANT_LEMON_BLOCK = registerBlock("giant_lemon_block", new Block(FabricBlockSettings.create().mapColor(MapColor.YELLOW).strength(0.5f).instrument(Instrument.DIDGERIDOO).requiresTool().nonOpaque().ticksRandomly().sounds(BlockSoundGroup.WOOD)));
    public static final Block GIANT_PLUM_BLOCK = registerBlock("giant_plum_block", new Block(FabricBlockSettings.create().mapColor(MapColor.DARK_DULL_PINK).strength(0.5f).instrument(Instrument.DIDGERIDOO).requiresTool().nonOpaque().ticksRandomly().sounds(BlockSoundGroup.WOOD)));
