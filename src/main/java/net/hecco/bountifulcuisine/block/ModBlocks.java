...
public class ModBlocks {
    ...
    public static final Block MILL = registerBlock("mill", new MillBlock(FabricBlockSettings.create().hardness(2.5f).instrument(Instrument.DIDGERIDOO).mapColor(MapColor.OAK_TAN).sounds(BlockSoundGroup.WOOD)));
