...
import net.hecco.bountifulcuisine.block.entity.HoneysuckleCandleBlockEntity;
...
public class HoneysuckleCandleBlock extends InfusedCandleBlock {
    ...
    public <T extends BlockEntity> BlockEntityTicker<T> getTicker(World world, BlockState state, BlockEntityType<T> type) {
        return validateTicker(type, ModBlockEntities.HONEYSUCKLE_CANDLE_BLOCK_ENTITY, HoneysuckleCandleBlockEntity::tick);
    }
}
