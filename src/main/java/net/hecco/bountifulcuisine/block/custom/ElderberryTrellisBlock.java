...
public class ElderberryTrellisBlock extends PlantedTrellisBlock {
    public ElderberryTrellisBlock(Item berryItem, Settings settings) {
    ...
    public ActionResult onUse(BlockState state, World world, BlockPos pos, PlayerEntity player, Hand hand, BlockHitResult hit) {
        ...
        if (player.getStackInHand(hand).isOf(Items.SHEARS) && !state.get(SNIPPED)) {
            ...
            dropStack(world, pos, new ItemStack(ModItems.ELDERBERRIES, j));
