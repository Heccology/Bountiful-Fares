...
public class TeaShrubBlock extends PlantBlock implements Fertilizable {
    ...
    private static final VoxelShape AGE0_SHAPE = Block.createCuboidShape(6, 0, 6, 10, 4, 10);
    private static final VoxelShape AGE1_SHAPE = Block.createCuboidShape(3, 0, 3, 13, 8, 13);
    private static final VoxelShape AGE4_SHAPE = VoxelShapes.combineAndSimplify(Block.createCuboidShape(6, 0, 6, 10, 8, 10), Block.createCuboidShape(0, 8, 0, 16, 16, 16), BooleanBiFunction.OR);
    ...
    public ActionResult onUse(BlockState state, World world, BlockPos pos, PlayerEntity player, Hand hand, BlockHitResult hit) {
        ...
        if (itemStack.isOf(Items.SHEARS)) {
            ...
            dropStack(world, pos, new ItemStack(ModItems.TEA_LEAVES));
            return ActionResult.SUCCESS;
        } else if (itemStack.isOf(Items.BONE_MEAL) && state.get(AGE) == 4 && !state.get(BERRIES) && !player.isCreative()) {
            ...
            dropStack(world, pos, new ItemStack(ModItems.TEA_BERRIES));
            return ActionResult.SUCCESS;
        }
