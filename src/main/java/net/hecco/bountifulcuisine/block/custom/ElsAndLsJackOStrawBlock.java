...
public class ElsAndLsJackOStrawBlock extends JackOStrawBlock{
    ...
    public void appendTooltip(ItemStack stack, @Nullable BlockView world, List<Text> tooltip, TooltipContext options) {
        if (!FabricLoader.getInstance().isModLoaded(BountifulCuisine.ELS_AND_LS_DYES_MOD_ID)) {
            tooltip.add(Text.translatable("tooltip.bountifulcuisine.els_and_ls_dye_mod_warning"));
            tooltip.add(Text.translatable("tooltip.bountifulcuisine.els_and_ls_dye_mod_warning1"));
        }
    }
}
