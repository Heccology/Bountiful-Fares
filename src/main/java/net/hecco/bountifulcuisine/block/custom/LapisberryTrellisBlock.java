...
public class LapisberryTrellisBlock extends PlantedTrellisBlock {
    public LapisberryTrellisBlock(Item berryItem, Settings settings) {
    ...
    public ActionResult onUse(BlockState state, World world, BlockPos pos, PlayerEntity player, Hand hand, BlockHitResult hit) {
        ...
        if (player.getStackInHand(hand).isOf(Items.SHEARS) && !state.get(SNIPPED)) {
            ...
            dropStack(world, pos, new ItemStack(ModItems.LAPISBERRIES, j));
