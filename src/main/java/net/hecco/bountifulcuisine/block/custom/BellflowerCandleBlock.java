...
import net.hecco.bountifulcuisine.block.entity.BellflowerCandleBlockEntity;
...
public class BellflowerCandleBlock extends InfusedCandleBlock {
    ...
    public <T extends BlockEntity> BlockEntityTicker<T> getTicker(World world, BlockState state, BlockEntityType<T> type) {
        return validateTicker(type, ModBlockEntities.BELLFLOWER_CANDLE_BLOCK_ENTITY, BellflowerCandleBlockEntity::tick);
    }
}
