...
public class ModBlockTags {
    ...
    public static final TagKey<Block> APPLE_LEAVES = TagKey.of(RegistryKeys.BLOCK, new Identifier(BountifulCuisine.MOD_ID, "apple_leaves"));
    public static final TagKey<Block> ORANGE_LEAVES = TagKey.of(RegistryKeys.BLOCK, new Identifier(BountifulCuisine.MOD_ID, "orange_leaves"));
    public static final TagKey<Block> LEMON_LEAVES = TagKey.of(RegistryKeys.BLOCK, new Identifier(BountifulCuisine.MOD_ID, "lemon_leaves"));
    public static final TagKey<Block> PLUM_LEAVES = TagKey.of(RegistryKeys.BLOCK, new Identifier(BountifulCuisine.MOD_ID, "plum_leaves"));
    public static final TagKey<Block> APPLE_LOGS = TagKey.of(RegistryKeys.BLOCK, new Identifier(BountifulCuisine.MOD_ID, "apple_logs"));
    ...
    public static final TagKey<Block> CERAMIC_TILES = TagKey.of(RegistryKeys.BLOCK, new Identifier(BountifulCuisine.MOD_ID, "ceramic_tiles"));
