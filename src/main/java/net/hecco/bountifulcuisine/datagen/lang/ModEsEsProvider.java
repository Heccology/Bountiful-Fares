...
public class ModEsEsProvider extends FabricLanguageProvider {
    ...
    public void generateTranslations(TranslationBuilder translationBuilder) {
        ...
        generate(translationBuilder, ModItems.CITRIC_ACID, "Ácido cítrico");
        generate(translationBuilder, "effect.bountifulcuisine.acidic", "Ácidic");
        generate(translationBuilder, "item.minecraft.potion.effect.bountifulcuisine.acidic", "Poción de ácido");
        generate(translationBuilder, "item.minecraft.potion.effect.bountifulcuisine.long_acidic", "Poción de ácido");
        generate(translationBuilder, "item.minecraft.potion.effect.bountifulcuisine.strong_acidic", "Poción de ácido");
        generate(translationBuilder, "item.minecraft.splash_potion.effect.bountifulcuisine.acidic", "Splash Poción de ácido");
        generate(translationBuilder, "item.minecraft.splash_potion.effect.bountifulcuisine.long_acidic", "Splash Poción de ácido");
        generate(translationBuilder, "item.minecraft.splash_potion.effect.bountifulcuisine.strong_acidic", "Splash Poción de ácido");
        generate(translationBuilder, "item.minecraft.lingering_potion.effect.bountifulcuisine.acidic", "Lingering Poción de ácido");
        generate(translationBuilder, "item.minecraft.lingering_potion.effect.bountifulcuisine.long_acidic", "Lingering Poción de ácido");
        generate(translationBuilder, "item.minecraft.lingering_potion.effect.bountifulcuisine.strong_acidic", "Lingering Poción de ácido");
        ...
        generate(translationBuilder, "effect.bountifulcuisine.ebullience", "Vitalidad");
        generate(translationBuilder, "effect.bountifulcuisine.gorging", "Atiborrarse");
        ...
        generate(translationBuilder, "tooltip.bountifulcuisine.els_and_ls_dye_mod_warning", "§7§oEl's and L's Dye Mod no está instalado!");
        generate(translationBuilder, "tooltip.bountifulcuisine.dyeable", "§7§oSe puede teñir");
        ...
        generate(translationBuilder, "warning.bountifulcuisine.fermentation_vessel.glass_bottle", "¡Necesitas usar un frasco a obtener este!");

        generate(translationBuilder, "advancement.bountifulcuisine.bountiful_cuisine", "Comida copioso");
        generate(translationBuilder, "advancement.bountifulcuisine.bountiful_cuisine.description", "¡El mundo está lleno con mas comida!");

        generate(translationBuilder, "advancement.bountifulcuisine.place_gristmill", "En la molienda");
        generate(translationBuilder, "advancement.bountifulcuisine.place_gristmill.description", "Coloca el molino.");

        generate(translationBuilder, "advancement.bountifulcuisine.obtain_feldspar", "Forrajeador félsica");
        generate(translationBuilder, "advancement.bountifulcuisine.obtain_feldspar.description", "Obtén feldespato por moliendo piedras.");

        generate(translationBuilder, "advancement.bountifulcuisine.obtain_ceramic_tiles", "ROY G BIV");
        generate(translationBuilder, "advancement.bountifulcuisine.obtain_ceramic_tiles.description", "Haz baldosas de cerámica.");

        generate(translationBuilder, "advancement.bountifulcuisine.feed_wolf_mulch", "Máxador de mantillo");
        generate(translationBuilder, "advancement.bountifulcuisine.feed_wolf_mulch.description", "Alimenta el lobo mantillo de nuez. ¡Que rico!");

        generate(translationBuilder, "advancement.bountifulcuisine.obtain_fermentation_vessel", "Doble penuria y doble labor");
        generate(translationBuilder, "advancement.bountifulcuisine.obtain_fermentation_vessel.description", "Haz una vasija de fermentación.");

        generate(translationBuilder, "advancement.bountifulcuisine.eat_ancient_fruit", "¿Cuánto tiempo ha estado esto fuera?");
        generate(translationBuilder, "advancement.bountifulcuisine.eat_ancient_fruit.description", "Come un fruto de el pasado distante.");

        generate(translationBuilder, "advancement.bountifulcuisine.place_all_baked_goods", "Docena de panadero");
        generate(translationBuilder, "advancement.bountifulcuisine.place_all_baked_goods.description", "Coloca cada pasteles.");

        generate(translationBuilder, "advancement.bountifulcuisine.eat_citric_acid", "Neccesito antiácido");
        generate(translationBuilder, "advancement.bountifulcuisine.eat_citric_acid.description", "Come ácido cítrico.");
        ...
        generate(translationBuilder, "advancement.bountifulcuisine.obtain_sun_hat", "Tiempo de cultivo");
        generate(translationBuilder, "advancement.bountifulcuisine.obtain_sun_hat.description", "Obtén el sombrero de sol.");

        generate(translationBuilder, "advancement.bountifulcuisine.eat_all_candy", "Estoy goloso");
        generate(translationBuilder, "advancement.bountifulcuisine.eat_all_candy.description", "Come cada caramelo.");

        generate(translationBuilder, "advancement.bountifulcuisine.gorge", "Quizá uno mas...");
        generate(translationBuilder, "advancement.bountifulcuisine.gorge.description", "Atibórrate.");

        generate(translationBuilder, "advancement.bountifulcuisine.obtain_tea_blends", "Té Té");
        generate(translationBuilder, "advancement.bountifulcuisine.obtain_tea_blends.description", "Obtén cada mezcla de té.");

        generate(translationBuilder, "advancement.bountifulcuisine.place_all_tea_candles", "¡Es fragante!");
        generate(translationBuilder, "advancement.bountifulcuisine.place_all_tea_candles.description", "Coloca cada vela de té.");

        generate(translationBuilder, "advancement.bountifulcuisine.obtain_walnut", "Deez");
        generate(translationBuilder, "advancement.bountifulcuisine.obtain_walnut.description", "Obtén una nuez.");
        ...
        generate(translationBuilder, "advancement.bountifulcuisine.obtain_spongekin.description", "Crece y junta un melón mullido.");
